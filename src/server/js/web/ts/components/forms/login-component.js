...
const app_router_js_1 = require("../../app/app-router.js");
const firebase_js_1 = require("../../app/firebase.js");
const url_manager_js_1 = require("../../app/url-manager.js");
const component_js_1 = require("../component.js");
class LoginComponent extends component_js_1.AbstractComponent {
    constructor(componentProps) {
        ...
        this.addListeners = () => {
            ...
            register.addEventListener('click', (event) => {
                ...
                url_manager_js_1.URLManager.setURL(app_router_js_1.Paths.REGISTER);
            });
        };
        this.login = async (event) => {
            ...
            let persistence = (remember === true) ? firebase_js_1.AuthPersistence.LOCAL : firebase_js_1.AuthPersistence.SESSION;
            try {
                let user = await firebase_js_1.Firebase.login(username, password, persistence);
