...
module.exports = class WifiManager{
    ...
    public async initCommunicationWithESP(): Promise<any>{
    ...
    public async scanForModuleAndConnect(): Promise<boolean> {
    ...
    _connectToEspApAync(SSID, pwd): Promise<any> {
        return new Promise( (resolve, reject) => {
